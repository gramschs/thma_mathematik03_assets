...
% -------- Kraft F_F = -k*y (Federkraft, zeigt nach links) ----
% Pfeil leicht oberhalb der Federlinie (y=0.8), an der linken Masseseite
\draw[my_red, line width=1.5pt, -{Stealth[length=8pt, width=5pt]}]
    (4.0, 0.2) -- (2.4, 0.2);
\node[my_red, anchor=west] at (0.75, 0.2)
    {\footnotesize $F_F = -k\,y$};

% -------- Kraft F_D = -d*y' (Dämpferkraft, zeigt nach links) -
% Pfeil leicht unterhalb der Dämpferlinie (y=-0.6), an der linken Masseseite
\draw[my_orange, line width=1.5pt, -{Stealth[length=8pt, width=5pt]}]
    (4.0, -0.1) -- (2.4, -0.1);
\node[my_orange, anchor=west] at (0.75, -0.1)
    {\footnotesize $F_D = -d\,y'$};
...
\draw[my_darkblue, line width=1.5pt, -{Stealth[length=8pt, width=5pt]}]
    (6.0, 0.0) -- (7.0, 0.0);
\node[my_darkblue, anchor=west] at (7.05, 0.0) {\footnotesize $F(t)$};
